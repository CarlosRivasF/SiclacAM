...
public class ShowOrds extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("<div class='nav-scroller bg-white box-shadow'>"
                + "    <nav class='nav nav-underline'>"//ShowOrds
        ...
        out.print("<div class='form-row'>"
                ...
                + "<input style='text-align: center' type='text' class='form-control' name='medi' onkeyup=SrchOrd(this,'pac'); id='medi' placeholder='Nombre de paciente' autofocus required>"
                + "</div>"
                + "</div>"
