...
<%
    ...
    if (sesion.getAttribute("permisos") != null && sesion.getAttribute("user") != null && sesion.getAttribute("unidad") != null) {        
        ...
        for (Permiso_DTO permisos : lst) {
            if (permisos.getNombre().equals("Médicos")) {
                r = false;
...
<html>
    <head>
        <title><%=empresa.getNombre_Empresa()%> | Médicos</title>
        <meta charset="UTF-8">
                ...
                <div class="navbar-collapse offcanvas-collapse bg-light" id="navbarsExampleDefault">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <%for (Permiso_DTO permisos1 : lst) {
                                if (permisos1.getNombre().equals("Médicos")) {%>
            ...
            <div id="Interaccion">
                <div class="nav-scroller bg-white box-shadow">
                    <nav class="nav nav-underline">
                        <a class="nav-link" href="#/" onclick="mostrarForm('Menu/Medico/Registro.jsp');">Nuevo Médico</a>
...
<%
        ...
        if (r) {
            sesion.setAttribute("msg", "Usted no tiene acceso al menú 'Médicos'.");
