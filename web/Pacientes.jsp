...
<%
    ...
    if (sesion.getAttribute("permisos") != null && sesion.getAttribute("user") != null && sesion.getAttribute("unidad") != null) {        
        ...
        for (Permiso_DTO permisos : lst) {
            if (permisos.getNombre().equals("Pacientes")) {
                r = false;
...
<html>
    <head>
        <title><%=empresa.getNombre_Empresa()%> | Pacientes</title>
        <meta charset="UTF-8">
                   ...
                   <strong><a class="navbar-brand" href="MainAdmin.jsp" style="color: black"><%=sesion.getAttribute("nombre_unidad").toString()%></a></strong>
                    <ul class="navbar-nav mr-auto">
                        <%for (Permiso_DTO permisos1 : lst) {
                                if (permisos1.getNombre().equals("Pacientes")) {%>
            ...
            <div id="Interaccion">
                <div class="nav-scroller bg-white box-shadow">
                    <nav class="nav nav-underline">
                        <a class="nav-link" href="#/" onclick="mostrarForm('Menu/Paciente/Registro.jsp');">Nuevo Paciente</a>
...
<%
        ...
        if (r) {
            sesion.setAttribute("msg", "Usted no tiene acceso al menú 'Pacientes'.");
